...
//  iGoldProperty
//
//  Created by Mariem Derbali on 12/9/23.
//
    ...
    var body: some View {
        ScrollView {
          ...
          Map(coordinateRegion: $coordinateRegion, annotationItems: [realEstate]){
            ...
            .cornerRadius(12)
            .onAppear{
                coordinateRegion.center = viewModel.realEstate.location
                coordinateRegion.span = viewModel.realEstate.city.zoomLevel
            ...
            Group{
                ...
                .padding(.top, 8)
                        ...
                        Button(action: {
                            ...
                            firebaseRealEstateManager.addRealEstate(realEstate: realEstate, images: images, videoUrl: videoUrl) { isSuccess in
                                ...
                                DispatchQueue.main.asyncAfter(deadline: .now() + 1.5){
                                    if isSuccess{
                                        ...
                                        isLoading.toggle()
                                        print("DEBUG: error while uploading real estate")
    ...
    static var previews: some View {
        ...
        SampleRealEstate(
            ...
            videoUrl: .constant(nil),
             coordinateRegion: .constant(.init(center: realEstateSample.location, span: realEstateSample.city.zoomLevel)),
